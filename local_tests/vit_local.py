...
for epoch in range(epochs):
    ...
    if val_loss < val_min:
        patience = 0
        val_min = val_loss
        torch.save(decoder.state_dict(), "./saved_models/best_vit_decoder.pth")
    ...
    if patience > 3:
        ...
        decoder.load_state_dict(torch.load("./saved_models/best_vit_decoder.pth"))
        break
...
print(f"Final Model Benchmark (ViT-B Backbone) (hidden_dim=256):")
