...
for epoch in range(epochs):
    ...
    if val_loss < val_min:
        patience = 0
        val_min = val_loss
        torch.save(decoder.state_dict(), "/kaggle/working/best_dinov3_decoder.pth")
    ...
    if patience > 3:
        ...
        decoder.load_state_dict(torch.load("/kaggle/working/best_dinov3_decoder.pth"))
        break
...
print(f"Final Model Benchmark (DINOv3 ViT-B Backbone):")
